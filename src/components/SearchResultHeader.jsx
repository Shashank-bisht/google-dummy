  ...
  return (
    <div className="p-[15px] pb-0 md:pr-5 md:pl-20 md:pt-7 border-b border-[#ebebeb] flex md:block flex-col items-center sticky top-0 bg-white">
      <div className="flex  items-center justify-between w-full">
        <div className="flex flex-col md:flex-row gap-2 items-center grow">
          <Link to="/"><img src={Logo} className="md:block w-[92px] mr-10" alt="" /></Link>
        ...
        {menu.map((menu, index) => (
          ...
          >
            ...
            {selectedMenu === menu.name && (
              <span className="h-[3px] w-[calc(100%-20px)] bg-[#1a73e8] absolute bottom-0"></span>
            )}
          </span>
        ))}
      </div>
